   ...
   <section class="main-slider">
        ...
        <div class="tp-banner-container">
            <div class="tp-banner" >
                <ul>
                    ...
                    style="z-index: 4; max-width: auto; max-height: auto; white-space: nowrap;"><div class="grey-title"><h2><strong>THE BEST</strong> REPAIR SERVICE</h2></div></div>
                    ...
                    data-endspeed="1200"
                    data-endeasing="Power4.easeIn"
                    style="z-index: 4; max-width: auto; max-height: auto; white-space: nowrap;"><div class="white-title"><h2>WEBSITE SINCE 2001</h2></div></div>
                    ...
                    data-endspeed="1200"
                    data-endeasing="Power4.easeIn"
                    style="z-index: 4; max-width: auto; max-height: auto; white-space: nowrap;"><div class="grey-title"><h2><strong>WE HEAR</strong> REPAIR AND <strong>DELIVER</strong></h2></div></div>
                    ...
                    data-endspeed="1200"
                    data-endeasing="Power4.easeIn"
                    style="z-index: 4; max-width: auto; max-height: auto; white-space: nowrap;"><div class="grey-title"><h2><strong>THE BEST</strong> ROAD ASSISTANCE SERVICE </h2></div></div>
                    ...
                    data-endspeed="1200"
                    data-endeasing="Power4.easeIn"
                    style="z-index: 4; max-width: auto; max-height: auto; white-space: nowrap;"><div class="white-title"><h2>IN YOUR AREA</h2></div></div>
	...
	<div id="templatemo_slider">
      <iframe src="map.html" width="1350" height="300"></iframe> <!-- map.html page is called in iframe -->  
  </div>
		...
		<div class="auto-container">
        	<div class="row clearfix">
                ...
                <div class="col-md-5 col-sm-12 col-xs-12 text-content">
                    ...
                    <div class="text">
                    	<p>We're the industry leader in providing Roadside Assistance services in India and globally. We're also the partner of choice for leading automotive companies in India and abroad. We have the largest network presence and are present in 950+ locations across India. </p>
                    </div>
                </div>
                ...
                <div class="col-md-7 col-sm-12 col-xs-12">
                	<div class="row clearfix">
                        <div class="col-md-6 col-sm-6 col-xs-12 wow fadeInUp box" data-wow-delay="0ms" data-wow-duration="1000ms"><a href="#" class="tab-link"><div class="icon"><span class="flaticon-transport100"></span></div><h4>950+ cities across India</h4><p>With you On every road</p><span class="arrow fa fa-angle-right"></span></a></div>
                        <div class="col-md-6 col-sm-6 col-xs-12 wow fadeInUp box" data-wow-delay="0ms" data-wow-duration="1000ms"><a href="#" class="tab-link"><div class="icon"><span class="flaticon-wrench1"></span></div><h4>Road Assistance</h4><p>2 wheeler and 4 wheeler</p><span class="arrow fa fa-angle-right"></span></a></div>
                    </div>
                    
                    <div class="row clearfix">
                        <div class="col-md-6 col-sm-6 col-xs-12 wow fadeInUp box" data-wow-delay="0ms" data-wow-duration="1000ms"><a href="#" class="tab-link"><div class="icon"><span class="flaticon-automobile8"></span></div><h4>Repair and inspection</h4><p>Customers vehicle repairing</p><span class="arrow fa fa-angle-right"></span></a></div>
                        <div class="col-md-6 col-sm-6 col-xs-12 wow fadeInUp box" data-wow-delay="0ms" data-wow-duration="1000ms"><a href="#" class="tab-link"><div class="icon"><span class="flaticon-transport100"></span></div><h4>Security inspections </h4><p>We care about security</p><span class="arrow fa fa-angle-right"></span></a></div>
                    </div>
                </div>
		...
		<div class="auto-container">
        	...
        	<div class="row clearfix">
                ...
                <article class="col-md-4 col-sm-6 col-xs-12 column-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1000ms">
                	<div class="inner-box">
                    	<figure class="image">
                        	<a href="#"><img src="images/resource/towing.jpg" alt="Image" title="Featured Service"></a>
                            <figcaption class="price"><sup></sup></figcaption>
                        </figure>
                        <div class="post-content clearfix">
                        	<h3 class="skew-lines">TOWING SERVICES</h3>
                        ...
                        <div class="overlay-box">
                        	<h3 class="skew-lines">TOWING SERVICE AND ACCIDENTAL TOWING</h3>
                            <div class="text">
                            	<p>We tow your vehicle for free up to a distance mentioned in the applicable plan, in cases when on-site repairs are not possible.<P>We ensure that your safety and peace of mind is not compromised by an accident through our accidental towing services.</P></p>
                                <br>
                ...
                <article class="col-md-4 col-sm-6 col-xs-12 column-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1000ms">
                	<div class="inner-box">
                    	<figure class="image">
                        	<a href="#"><img src="images/resource/images.jpg" alt="Image" title="Featured Service"></a>
                            <figcaption class="price"><sup></sup></figcaption>
                        </figure>
                        <div class="post-content clearfix">
                        	<h3 class="skew-lines">24x7 Roadside Assistance</h3>
                            <div class="text-center"><a href="#" class="theme-btn btn-style-one"><span class="fa fa-angle-right"></span> GET A QUOTE</a> <a href="#" class="theme-btn dark-btn">Read More</a></div>
                        </div>
                        ...
                        <div class="overlay-box">
                        	<h3 class="skew-lines">24x7 Roadside Assistance</h3>
                            <div class="text">
                            	<p>Breakdowns are unpredictable, that's why we're available 24x7x365. We also help you with troubleshooting over phone for warning signs etc.</p>
                                <br>
                                <a href="#" class="theme-btn dark-btn style-two"><span class="fa fa-angle-right"></span> GET A QUOTE</a>
                            </div>
                        </div>
                ...
                <article class="col-md-4 col-sm-6 col-xs-12 column-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1000ms">
                	<div class="inner-box">
                    	<figure class="image">
                        	<a href="#"><img src="images/resource/repair.jpg" alt="Image" title="Featured Service"></a>
                            <figcaption class="price"><sup></sup></figcaption>
                        </figure>
                        <div class="post-content clearfix">
                        	<h3 class="skew-lines">Minor On-site repairs</h3>
                            <div class="text-center"><a href="#" class="theme-btn btn-style-one"><span class="fa fa-angle-right"></span> GET A QUOTE</a> <a href="#" class="theme-btn dark-btn">Read More</a></div>
                        </div>
                        <div class="overlay-box">
                        	<h3 class="skew-lines">Minor On-site repairs</h3>
                            <div class="text">
                            	<p>Our fully trained technicians are available 24X7 for all minor on-the-spot repairs </p>
                                <br>
                                <a href="#" class="theme-btn dark-btn style-two"><span class="fa fa-angle-right"></span> GET A QUOTE</a>
                            </div>
                        </div>
